...
14 de noviembre de 2.018: estoy en la sección de 'Trabajo desarrollado en el proyecto' (es decir, todo lo que no es capítulo 1), explicando y actualizando cosas sobre los resultados (concretamente consumos CPU y RAM, FPS obtenidos, ejemplos ejecuciones) del comando en consola 'estimacion_potencia.py Videos/varios_heliostatos.mp4 50 50 127 2'. Pregunté a Vicente que si sería también recomendable explicar todo esto pero para el caso (comando) 'estimacion_potencia.py Videos/heliostato.MOV 50 50 200 1', y me respondió que sí.
